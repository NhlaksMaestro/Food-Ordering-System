...
{
    public class FoodOrderingSystemXmlRepository : IFoodOrderingSystemRepository
    {
        FoodOrderingSystemDBContext _dBContext = default(FoodOrderingSystemDBContext);
        public FoodOrderingSystemXmlRepository()
        {
        ...
        public List<OrderedItem> GetOrderedItemByMenuItemId(int menuItemId)
        {
            try
            {
                var orders = _dBContext.OrderedItems
                    .Where<OrderedItem>(ord => ord.MenuItem.MenuItemId == menuItemId)
                    .ToList();
                return orders;
            }
            catch (Exception ex)
        ...
        public List<OrderedItem> GetOrderedItemByUserId(int userId)
        {
            ...
            {
                var orders = _dBContext.OrderedItems
                    .Where<OrderedItem>(ord => ord.Order.CustomerId == userId)
                    .ToList();
                return orders;
            }
            catch (Exception ex)
        ...
        public List<OrderedItem> GetOrderedItemByOrderId(int orderId)
        {
            ...
            {
                var orders = _dBContext.OrderedItems
                    .Where<OrderedItem>(ord => ord.Order.OrderId == orderId)
                    .ToList();
                return orders;
            }
            catch (Exception ex)
        ...
        public List<MenuItem> GetMenuItemByOrderId(int categoryId)
        {
            try
            {
